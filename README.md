...
[![Release](https://img.shields.io/badge/Release-v0.1.4-blue.svg)](https://github.com/kcoaguila-dev/scaffild/releases)
...
| :--- | :--- | :--- |
| **Windows Setup Wizard** | `scaffild_0.1.4_x64-setup.exe` | Standard Windows installer with Start Menu & Desktop shortcuts |
| **Windows MSI Package** | `scaffild_0.1.4_x64_en-US.msi` | Enterprise & silent installation package |
